                ...
                <form action="{{route('post.store')}}" method="POST">
                    ...
                    <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse border-t border-gray-100">
                        ...
                        {{-- <span class="flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
							<a href="{{route('dashboard')}}" type="button" class="inline-flex justify-center w-full rounded-md border
                        border-gray-300 px-4 py-2 bg-white text-base leading-6 font-medium text-gray-700 shadow-sm
                        hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline transition
