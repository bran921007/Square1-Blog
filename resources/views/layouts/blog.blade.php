  ...
  <div id="app">
    <div class="lg:max-w-screen-lg px-5 mx-auto mb-10">
      ...
      <header class="flex items-center justify-between py-5">
        <a href="http://127.0.0.1:8000" class="px-2 lg:px-0 font-bold">
      ...
      <ul class="hidden md:inline-flex items-center">
        ...
        @auth
            ...
            <a href="{{route('dashboard')}}" class="text-gray-500 font-semibold no-underline hover:underline"> {{auth()->user()->full_name}} </a>
        </li>
        @else
        <li class="px-2 md:px-4 hidden md:block">
