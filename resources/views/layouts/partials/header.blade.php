    ...
    <header class="flex items-center justify-between py-5">
        ...
        <ul class="hidden md:inline-flex items-center">
            ...
            <li class="px-2 md:px-4 hidden md:block">
                <a href="{{route('login')}}" class="text-gray-500 font-semibold no-underline hover:underline"> Login
                </a>
            </li>
            <li class="px-2 md:px-4 hidden md:block">
                <a href="{{route('register')}}" class="text-gray-500 font-semibold no-underline hover:underline">
                    Register </a>
            </li>
            @else
            <li class="px-2 md:px-4 hidden md:block">
                <a href="{{route('dashboard')}}" class="text-gray-500 font-semibold no-underline hover:underline">
                    Manage Posts </a>
            </li>
            @endguest
        </ul>
